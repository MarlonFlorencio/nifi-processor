 ...
 */
package com.github.marlonflorencio.nifi.processor2;
...
import static com.github.marlonflorencio.nifi.processor2.KafkaProcessorUtils.HEX_ENCODING;
import static com.github.marlonflorencio.nifi.processor2.KafkaProcessorUtils.UTF8_ENCODING;
...
public class MyConsumeKafka_2_6 extends AbstractProcessor {
    ...
    protected ConsumerPool createConsumerPool(final ProcessContext context, final ComponentLog log) {
        ...
        final byte[] demarcator = context.getProperty(MyConsumeKafka_2_6.MESSAGE_DEMARCATOR).isSet()
                ? context.getProperty(MyConsumeKafka_2_6.MESSAGE_DEMARCATOR).evaluateAttributeExpressions().getValue().getBytes(StandardCharsets.UTF_8)
                : null;
        ...
        final String topicListing = context.getProperty(MyConsumeKafka_2_6.TOPICS).evaluateAttributeExpressions().getValue();
        final String topicType = context.getProperty(MyConsumeKafka_2_6.TOPIC_TYPE).evaluateAttributeExpressions().getValue();
