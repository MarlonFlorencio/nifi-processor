 ...
 */
package com.github.marlonflorencio.nifi.data.model;
...
public class Entrega extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.github.marlonflorencio.nifi.data.model.Entrega.Builder newBuilder() {
    return new com.github.marlonflorencio.nifi.data.model.Entrega.Builder();
  }
   ...
   * @return A new Entrega RecordBuilder
   */
  public static com.github.marlonflorencio.nifi.data.model.Entrega.Builder newBuilder(com.github.marlonflorencio.nifi.data.model.Entrega.Builder other) {
    if (other == null) {
      return new com.github.marlonflorencio.nifi.data.model.Entrega.Builder();
    } else {
      return new com.github.marlonflorencio.nifi.data.model.Entrega.Builder(other);
    }
  }
   ...
   * @return A new Entrega RecordBuilder
   */
  public static com.github.marlonflorencio.nifi.data.model.Entrega.Builder newBuilder(com.github.marlonflorencio.nifi.data.model.Entrega other) {
    if (other == null) {
      return new com.github.marlonflorencio.nifi.data.model.Entrega.Builder();
    } else {
      return new com.github.marlonflorencio.nifi.data.model.Entrega.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Entrega>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.github.marlonflorencio.nifi.data.model.Entrega.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.github.marlonflorencio.nifi.data.model.Entrega other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.endereco)) {
        this.endereco = data().deepCopy(fields()[0].schema(), other.endereco);
     ...
     * @return This builder.
     */
    public com.github.marlonflorencio.nifi.data.model.Entrega.Builder setEndereco(java.lang.String value) {
     ...
     * @return This builder.
     */
    public com.github.marlonflorencio.nifi.data.model.Entrega.Builder clearEndereco() {
      endereco = null;
     ...
     * @return This builder.
     */
    public com.github.marlonflorencio.nifi.data.model.Entrega.Builder setNumero(java.lang.String value) {
     ...
     * @return This builder.
     */
    public com.github.marlonflorencio.nifi.data.model.Entrega.Builder clearNumero() {
      numero = null;
     ...
     * @return This builder.
     */
    public com.github.marlonflorencio.nifi.data.model.Entrega.Builder setCidade(java.lang.String value) {
     ...
     * @return This builder.
     */
    public com.github.marlonflorencio.nifi.data.model.Entrega.Builder clearCidade() {
      cidade = null;
     ...
     * @return This builder.
     */
    public com.github.marlonflorencio.nifi.data.model.Entrega.Builder setStatus(java.lang.String value) {
     ...
     * @return This builder.
     */
    public com.github.marlonflorencio.nifi.data.model.Entrega.Builder clearStatus() {
      status = null;
